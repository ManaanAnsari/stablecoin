...
contract HelperConfig is Script {
    ...
    int256 public constant WBTC_PRICE = 50000e8;
    ...
    function getOrCreateAnvilNetworkConfig() public returns (NetworkConfig memory) {
        ...
        vm.startBroadcast();
        MockV3Aggregator ethUsdPriceFeed = new MockV3Aggregator(DECIMALS, WETH_PRICE);
        MockV3Aggregator wbtcUsdPriceFeed = new MockV3Aggregator(DECIMALS, WBTC_PRICE);
